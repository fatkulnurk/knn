...
- jalankan perintah _git clone https://github.com/fatkulnurk/knn.git_ pada direktory htdocs (jika pakai xampp), tetapi jika pakai php builth in server bebas mau mana aja.
- jalankan __composer update__
- jalankan webserver anda, siap di pakai.